...
static void mavlink_test_kriso_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_KRISO_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_kriso_status_t packet_in = {
        93372036854775807ULL,179.0,235.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,521.0,549.0,577.0,605.0,633.0,661.0,689.0,717.0,745.0,773.0,85
    };
    mavlink_kriso_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.nav_longitude = packet_in.nav_longitude;
        packet1.nav_latitude = packet_in.nav_latitude;
        packet1.nav_roll = packet_in.nav_roll;
        packet1.nav_pitch = packet_in.nav_pitch;
        packet1.nav_yaw = packet_in.nav_yaw;
        packet1.nav_cog = packet_in.nav_cog;
        packet1.nav_sog = packet_in.nav_sog;
        packet1.nav_uspd = packet_in.nav_uspd;
        packet1.nav_vspd = packet_in.nav_vspd;
        packet1.nav_wspd = packet_in.nav_wspd;
        packet1.nav_heave = packet_in.nav_heave;
        packet1.nav_gpstime = packet_in.nav_gpstime;
        packet1.wea_airtem = packet_in.wea_airtem;
        packet1.wea_wattem = packet_in.wea_wattem;
        packet1.wea_press = packet_in.wea_press;
        packet1.wea_relhum = packet_in.wea_relhum;
        packet1.wea_dewpt = packet_in.wea_dewpt;
        packet1.wea_windirt = packet_in.wea_windirt;
        packet1.wea_winspdt = packet_in.wea_winspdt;
        packet1.wea_windirr = packet_in.wea_windirr;
        packet1.wea_watspdr = packet_in.wea_watspdr;
        packet1.wea_watdir = packet_in.wea_watdir;
        packet1.wea_watspd = packet_in.wea_watspd;
        packet1.wea_visibiran = packet_in.wea_visibiran;
        packet1.nav_mode = packet_in.nav_mode;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_KRISO_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_KRISO_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kriso_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_kriso_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kriso_status_pack(system_id, component_id, &msg , packet1.time_usec , packet1.nav_mode , packet1.nav_roll , packet1.nav_pitch , packet1.nav_yaw , packet1.nav_cog , packet1.nav_sog , packet1.nav_uspd , packet1.nav_vspd , packet1.nav_wspd , packet1.nav_longitude , packet1.nav_latitude , packet1.nav_heave , packet1.nav_gpstime , packet1.wea_airtem , packet1.wea_wattem , packet1.wea_press , packet1.wea_relhum , packet1.wea_dewpt , packet1.wea_windirt , packet1.wea_winspdt , packet1.wea_windirr , packet1.wea_watspdr , packet1.wea_watdir , packet1.wea_watspd , packet1.wea_visibiran );
    mavlink_msg_kriso_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kriso_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.nav_mode , packet1.nav_roll , packet1.nav_pitch , packet1.nav_yaw , packet1.nav_cog , packet1.nav_sog , packet1.nav_uspd , packet1.nav_vspd , packet1.nav_wspd , packet1.nav_longitude , packet1.nav_latitude , packet1.nav_heave , packet1.nav_gpstime , packet1.wea_airtem , packet1.wea_wattem , packet1.wea_press , packet1.wea_relhum , packet1.wea_dewpt , packet1.wea_windirt , packet1.wea_winspdt , packet1.wea_windirr , packet1.wea_watspdr , packet1.wea_watdir , packet1.wea_watspd , packet1.wea_visibiran );
    mavlink_msg_kriso_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_kriso_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_kriso_status_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.nav_mode , packet1.nav_roll , packet1.nav_pitch , packet1.nav_yaw , packet1.nav_cog , packet1.nav_sog , packet1.nav_uspd , packet1.nav_vspd , packet1.nav_wspd , packet1.nav_longitude , packet1.nav_latitude , packet1.nav_heave , packet1.nav_gpstime , packet1.wea_airtem , packet1.wea_wattem , packet1.wea_press , packet1.wea_relhum , packet1.wea_dewpt , packet1.wea_windirt , packet1.wea_winspdt , packet1.wea_windirr , packet1.wea_watspdr , packet1.wea_watdir , packet1.wea_watspd , packet1.wea_visibiran );
    mavlink_msg_kriso_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("KRISO_STATUS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_KRISO_STATUS) != NULL);
#endif
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_kriso_status(system_id, component_id, last_msg);
